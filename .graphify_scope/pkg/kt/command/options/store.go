...
type RuntimeStore struct {
	...
	// isIpv6Cluster
	Ipv6Cluster bool
	// Lane lane-aware connect lane
	Lane string
	// Session session identifier for connect-scoped resources
	Session string
	// LaneEnvoyFilter envoyfilter name created for lane-aware connect
	LaneEnvoyFilter string
}
